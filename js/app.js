(() => {
    ...
    (() => {
        ...
        function headerBtnHover() {
            document.querySelector(".header__btn").addEventListener("mouseenter", (() => {
                document.querySelector(".main-page__background").classList.add("_filter");
            }));
            document.querySelector(".header__btn").addEventListener("mouseleave", (() => {
                document.querySelector(".main-page__background").classList.remove("_filter");
            }));
        }
        headerBtnHover();
        window["FLS"] = true;
